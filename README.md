...
**Course Contents:**
*  **Lab 1** - Exploring Machine Learning Algorithms for Genre Classification
*  **Lab 2** - Convolutional Neural Networks
*  **Lab 5** - Supervised Learning with CNN's
*  **Lab 6** - Self-Supervised Learning and Autoencoders
